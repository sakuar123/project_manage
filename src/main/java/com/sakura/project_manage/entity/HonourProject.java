...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "荣誉类项目")
@Table(name = "honour_project")
public class HonourProject implements Serializable {
    ...
    public enum Column {
        ...
        honourName("honour_name", "honourName", "VARCHAR", false),
        ...
        reportCondition("report_condition", "reportCondition", "VARCHAR", false),
