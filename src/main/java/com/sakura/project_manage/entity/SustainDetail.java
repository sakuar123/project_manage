...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "支持信息表")
@Table(name = "sustain_detail")
public class SustainDetail implements Serializable {
    ...
    public enum Column {
        ...
        sustainDesc("sustain_desc", "sustainDesc", "VARCHAR", false),
