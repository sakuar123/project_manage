...
/**
 * Created by Mybatis Generator on 2023/03/08
 * @author 李七夜
 */
@Data
@Builder
...
public class OperateLogDetail implements Serializable {
    ...
    public enum Column {
        ...
        operateFunction("operate_function", "operateFunction", "VARCHAR", false),
        ipLocation("ip_location", "ipLocation", "VARCHAR", false),
        operateDesc("operate_desc", "operateDesc", "VARCHAR", false),
