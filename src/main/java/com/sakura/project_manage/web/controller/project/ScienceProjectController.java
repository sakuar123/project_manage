...
@RestController
@Api(tags = "科技类项目管理")
@RequestMapping("/project/science/")
public class ScienceProjectController {

    @Resource
    private ScienceProjectService service;
    ...
    public Boolean add(@RequestBody ScienceProjectVo entity) {
    ...
    @RequiresPermissions("SECTION_MANAGE_DEL")
    public Boolean edit(@RequestBody ScienceProjectVo entity) {
