...
@RestController
@Api(tags = "科技类项目管理器")
@RequestMapping("/project/honour/")
public class HonourProjectController {

    @Resource
    private HonourProjectService service;
    ...
    public Boolean add(@RequestBody HonourProject entity) {
    ...
    @RequiresPermissions("SECTION_MANAGE_DEL")
    public Boolean edit(@RequestBody HonourProject entity) {
